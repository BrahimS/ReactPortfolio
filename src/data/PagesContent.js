const ContentPage = {
  "about" : [
    ...
    "projects": [
      {
        intro: "As a freelancer, I had the chance to work for different companies. During these years of experience, I enjoyed working with small businesses, which allowed me to combine the process of research, creation and development.",
        footer: "© 2016 Brahim Sourny | all right reserved"
      }
  ]
};
